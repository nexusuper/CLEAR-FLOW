...
// Store origin for the admin "Open route in Google Maps" button.
// EDIT this to the real store address so directions start from the right place.
export const STORE_MAP_ORIGIN = 'Phase 2B, Villa Trinitas, Barangay Bugo, Cagayan de Oro City';

// ponytail: STORE_MAP_ORIGIN above is a text address (for the Google Maps
// directions link), not coords. LocationPicker needs a numeric center point,
// so approximate Brgy. Bugo, CDO coords here. Nudge to the exact store pin if known.
export const STORE_LAT = 8.5013;
export const STORE_LNG = 124.729;
