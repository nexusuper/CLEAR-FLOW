...
export default function MessengerButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex items-center gap-2 pl-4 pr-5 h-14 rounded-full bg-[#0084FF] shadow-lg hover:bg-[#006AFF] hover:scale-105 active:scale-95 transition-all"
    >
      ...
      <span className="text-white font-semibold text-base">Message us</span>
    </a>
  );
}
